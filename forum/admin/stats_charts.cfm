...
<!--- Disabling for now --->
<cfabort/>
<cfquery name="conferences" datasource="#APPLICATION.DSN.FORUM#">
select	id, name
from	forum_conferences
</cfquery>

<cfquery name="forums" datasource="#APPLICATION.DSN.FORUM#">
select	id, name, conferenceidfk
from	forum_forums
</cfquery>

<!---<cfset threads = APPLICATION.FORUM.Thread.getThreads()>--->
<!---<cfset users = APPLICATION.FORUM.User.getUsers()>--->
