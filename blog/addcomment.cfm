...
<cfif SESSION.LoggedIn>
	...
	<cfset form.website = "#APPLICATION.PATH.FULL#/#SESSION.USER.user#/p.brewer.cfm" />
...
<cfif isDefined("form.addcomment") and entry.allowcomments>
	...
	<cfif len(form.website) and not isURL(form.website)><cfset arrayAppend(aErrors, rb("invalidurl")) /></cfif>
			...
			<div class="ui-widget-content">
				...
				<table class="datagrid noborder" cellspacing="0" width="640">
					...
					<cfelse>
						...
						<tr>
							<td class="label">#rb("website")#:</td>
							<td><input type="text" id="website" name="website" value="#form.website#" /></td>
						</tr>
					</cfif>
						<tr>
