...
<cfmodule template="../../tags/podlayout.cfm" title="#APPLICATION.BLOG.resourceBundle.getResource("archivesbysubject")#">
	...
	<cfloop query="cats">
		<cfoutput><a href="#SESSION.BROG.makeCategoryLink(categoryid)#" title="#categoryName# RSS">#categoryName# (#entryCount#)</a> [<a href="#APPLICATION.PATH.ROOT#/rss.cfm?mode=full&amp;mode2=cat&amp;catid=#categoryid#" rel="noindex,nofollow">RSS</a>]<br /></cfoutput>
	</cfloop>
