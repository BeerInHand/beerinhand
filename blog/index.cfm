	...
	<cfmodule template="tags/layout.cfm" attributecollection="#data#">
		...
		<cfloop query="articles">
			...
			<cfif articles.RecordCount is 1>
				...
				<cfif allowComments>
					<cfoutput>
					<h3>#rb("comments")#<cfif NOT SESSION.LoggedIn AND SESSION.BROG.getProperty("moderate")><span class="moderated">#rb("moderation")#</span></cfif></h3>
							...
							<li class="comment" id="c#id#">
								<div class="comment-mask regularcomment">
									...
									<div id="comment-body-#currentRow#" class="ui-widget-content comment-body clearfix">
										<div class="avatar">
											<cfif len(comments.website)>
												<a href="#comments.website#" rel="nofollow"><img src="#avSrc#" border="0" class="avatar avatar-64 photo" height="64" width="64" /></a>
											<cfelse>
