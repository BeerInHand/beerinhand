	...
	<div id="statstabs">
		...
		<div id="categorystats">
			<table class="datagrid" width="100%" cellspacing="0">
				...
				<tr>
					<td class="label" width="250"><a href="#SESSION.BROG.makeCategoryLink(categoryid)#">#categoryname#</a></td>
		...
		<div id="topcategoriesbycomments">
			...
			<table class="datagrid" width="100%" cellspacing="0">
				<cfloop query="topCommentedCategories">
					...
					<tr>
						<td class="label" width="250"><a href="index.cfm?mode=cat&amp;catid=#categoryid#" rel="nofollow">#categoryname#</a></td>
