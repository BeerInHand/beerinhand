...
<cfif URL.id is not 0>
	<cftry>
	<cfset page = APPLICATION.BLOG.page.getPage(URL.id)>
	<cfif structIsEmpty(page)>
		<cflocation url="x.pages.cfm" addToken="false">
	</cfif>
	<cfcatch>
		<cflocation url="x.pages.cfm" addToken="false">
	</cfcatch>
...
<cfif structKeyExists(form, "save")>
	...
	<cfif not arrayLen(errors)>
		<cfset APPLICATION.BLOG.page.savePage(URL.id, left(form.title,255), left(form.alias,50), form.body, form.showlayout, form.categories)>
...
<cfmodule template="../tags/adminlayout.cfm" title="Page Editor">
	...
	<cfoutput>
	<form action="x.page.cfm?id=#URL.id#" method="post">
	<table>
		<tr>
		...
		<tr valign="top">
			...
			<td><a href="#APPLICATION.PATH.ROOT#/page.cfm/#form.alias#">#APPLICATION.PATH.ROOT#/page.cfm/#form.alias#</a></td>
		</tr>
		</cfif>
		<tr valign="top">
