...
<cfif structKeyExists(form, "save")>
	...
	<cfif not arrayLen(errors)>
		<cfset SESSION.BROG.saveComment(URL.id, left(form.name,50), left(form.email,50), left(form.website,255), form.comment, form.subscribe, form.moderated)>
		<cflocation url="x.comments.cfm" addToken="false">
	</cfif>
</cfif>
		...
		<table class="datagrid noborder" cellspacing="0" width="640">
			<tbody class="bih-grid-form nobevel">
				...
				<tr>
					...
					<td><cfinvoke component="#APPLICATION.CFC.Controls#" method="Create" type="url" maxlen="150" value="#form.website#" name="website" class="txtField" /></td>
				</tr>
				<tr valign="top">
