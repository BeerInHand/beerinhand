...
<cfif StructKeyExists(URL, "killcomment")><cfset SESSION.BROG.killComment(URL.killcomment)></cfif><!--- KILLSWITCH FOR COMMENTS. WE DON'T AUTHENTICATE BECAUSE THIS KILL UUID IS SOMETHING ONLY THE ADMIN CAN GET. --->
