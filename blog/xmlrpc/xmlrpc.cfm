		...
		<cfif SESSION.BROG.authenticate(username,password)>
			...
			<cfloop query="categories">
				...
				<cfif requestData.method is "metaWeblog.getCategories">
					...
					<cfset info["htmlUrl"] = "$string" & SESSION.BROG.makeCategoryLink(categoryid)>
					<cfset info["rssUrl"] = "$string" & "#APPLICATION.PATH.ROOT#/rss.cfm?mode=full&mode2=cat&catid=#categoryid#">
